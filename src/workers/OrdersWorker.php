...
define('EXCHANGE_MAIN', 'orders_exc');
define('EXCHANGE_TRASH', 'orders_exc_trash');
define('QUEUE_MAIN', 'ploomes_orders');
define('QUEUE_TRASH', 'ploomes_orders_trash');
define('BINDING_KEY_MAIN', 'Ploomes.Orders');
define('BINDING_KEY_TRASH', 'Ploomes.Orders.Trash');
