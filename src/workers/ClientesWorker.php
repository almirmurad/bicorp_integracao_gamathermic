...
define('EXCHANGE_MAIN', 'clientes_exc');
define('EXCHANGE_TRASH', 'clientes_exc_trash');
define('QUEUE_MAIN', 'omie_clientes');
define('QUEUE_TRASH', 'omie_clientes_trash');
define('BINDING_KEY_MAIN', 'Omie.Clientes');
define('BINDING_KEY_TRASH', 'Omie.Clientes.Trash');
