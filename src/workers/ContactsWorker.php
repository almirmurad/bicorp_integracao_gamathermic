...
define('EXCHANGE_MAIN', 'contacts_exc');
define('EXCHANGE_TRASH', 'contacts_exc_trash');
define('QUEUE_MAIN', 'ploomes_contacts');
define('QUEUE_TRASH', 'ploomes_contacts_trash');
define('BINDING_KEY_MAIN', 'Ploomes.Contacts');
define('BINDING_KEY_TRASH', 'Ploomes.Contacts.Trash');
define('RETRY_LIMIT', 2);
define('PROCESS_URI', 'https://gamatermic.bicorp.online/public/processNewContact');
