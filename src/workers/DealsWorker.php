...
define('EXCHANGE_MAIN', 'deals_exc');
define('EXCHANGE_TRASH', 'deals_exc_trash');
define('QUEUE_MAIN', 'ploomes_deals');
define('QUEUE_TRASH', 'ploomes_deals_trash');
define('BINDING_KEY_MAIN', 'Ploomes.Deals');
define('BINDING_KEY_TRASH', 'Ploomes.Deals.Trash');
