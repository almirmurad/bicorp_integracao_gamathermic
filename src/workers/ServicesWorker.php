...
define('EXCHANGE_MAIN', 'services_exc');
define('EXCHANGE_TRASH', 'services_exc_trash');
define('QUEUE_MAIN', 'omie_services');
define('QUEUE_TRASH', 'omie_services_trash');
define('BINDING_KEY_MAIN', 'Omie.Services');
define('BINDING_KEY_TRASH', 'Omie.Services.Trash');
define('RETRY_LIMIT', 2);
define('PROCESS_URI', 'https://gamatermic.bicorp.online/public/processNewService');
