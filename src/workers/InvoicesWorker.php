...
define('EXCHANGE_MAIN', 'invoices_exc');
define('EXCHANGE_TRASH', 'invoices_exc_trash');
define('QUEUE_MAIN', 'omie_invoices');
define('QUEUE_TRASH', 'omie_invoices_trash');
define('BINDING_KEY_MAIN', 'Omie.Invoices');
define('BINDING_KEY_TRASH', 'Omie.Invoices.Trash');
define('RETRY_LIMIT', 2);
define('PROCESS_URI', 'https://gamatermic.bicorp.online/public/processNewInvoice');
