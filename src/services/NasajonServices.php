...
class NasajonServices implements ErpManagerInterface{
    ...
    public function clienteIdErp($omie, $contactCnpj)
    {      
        $jsonOmieIdCliente = [
            'app_key' => $omie->appKey,
    ...
    public function criaPedidoErp(object $omie, object $order, array $productsOrder)
    {      
        $top = [
            'app_key' =>   $omie->appKey,
            'app_secret' => $omie->appSecret,
    ...
    public function criaClienteErp(object $contact)
    {
        ...
        print_r($json) .PHP_EOL;
        print_r('criar') .PHP_EOL;
        exit;
    ...
    // busca o pedido através do Id do OMIE
    public function buscaIdProjetoErp(object $omie, string $projetoName)
    {
        $array = [
                    'app_key'=>$omie->appKey,
                    'app_secret'=>$omie->appSecret,
    ...
    public function alteraCliente(object $contact)
    {   
        // $array = [
        //     'app_key'=>$omie->appKey,
        //     'app_secret'=>$omie->appSecret,
    ...
    //altera um cliente no OMIE com base nas difereças dos arrays Old e News do Ploomes
    public function alteraClienteCRMToERP(object $contact)
    {   
    ...
    public function deleteClienteErp(object $omie, object $contact)
    {  
